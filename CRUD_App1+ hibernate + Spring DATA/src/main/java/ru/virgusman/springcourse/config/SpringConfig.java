...
@EnableJpaRepositories("ru.virgusman.springcourse.repositories")
public class SpringConfig implements WebMvcConfigurer {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("ru.virgusman.springcourse.models");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("ru.virgusman.springcourse.models");
